...
/******/ 	__webpack_require__.p = "https://kevinj.dev/";
/******/
...
})(['flex:1 1 auto;background:#0068A0;display:flex;justify-content:center;align-items:center;flex-direction:column;padding:1rem;h1,p{color:#fff;}h1{font-size:3rem;}p{font-size:2rem;}button{font-size:2rem;color:#fff;background:transparent;border:1px solid white;padding:1rem;margin-top:3rem;display:inline-block;vertical-align:middle;transform:translateZ(0);box-shadow:0 0 1px rgba(0,0,0,0);backface-visibility:hidden;-moz-osx-font-smoothing:grayscale;transition-duration:0.3s;transition-property:transform;}button:hover{cursor:pointer;transform:scale(1.1);}']);
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      tl.from(this.h.current, 2, {
        ...
        _this2.about.current.style.transform = "";
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          function (c) {
            _this3.transitFunc = c.transitFunc;
          }
        ),
        _react2.default.createElement(
          'h1',
              ...
              return _react2.default.createElement(
                'button',
                {
                  ...
                  onClick: function onClick() {
                    _this3.handleAboutClick(history);
                  } },
                'About me'
              );
            } })
...
})(['flex:1 1 auto;background:#CAF27B;display:flex;justify-content:center;align-items:center;flex-direction:column;padding:1rem;h1,p,button{color:#1f2d3d;}h1{font-size:3rem;}p{font-size:2rem;}button{font-size:2rem;background:transparent;border:1px solid #1f2d3d;padding:1rem;margin-top:3rem;}.container{display:flex;flex-direction:row;justify-content:center;align-items:center;}a{width:4rem;height:4rem;margin-left:1.2rem;}a,button{display:inline-block;vertical-align:middle;transform:translateZ(0);box-shadow:0 0 1px rgba(0,0,0,0);backface-visibility:hidden;-moz-osx-font-smoothing:grayscale;transition-duration:0.3s;transition-property:transform;transition-timing-function:ease-out;}a:hover,button:hover{cursor:pointer;transform:scale(1.1);}']);
...
var About = function (_Component) {
  ...
  function About(props) {
    ...
    _this.h = _react2.default.createRef();
    _this.t = _react2.default.createRef();
    _this.g = _react2.default.createRef();
    _this.home = _react2.default.createRef();
    return _this;
  }
  ...
  _createClass(About, [{
    ...
    value: function componentDidMount() {
      ...
      tl.from(this.h.current, 1.5, {
        ...
        y: 40,
        ease: Back.easeIn
      }, "-=1").from(this.g.current, 1.5, {
        opacity: 0,
        x: 40,
        ease: Back.easeIn
      }, "-=1").from(this.home.current, 2, {
        opacity: 0,
        y: 40,
        ease: Back.easeOut
      }, "+=0.5").add(function () {
        _this2.home.current.style.transform = "";
      });
    }
  }, {
    key: 'handleHomeClick',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: 'https://github.com/wjdwndud0114/' },
            _react2.default.createElement(
              'svg',
              { ref: this.g, viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
              _react2.default.createElement(
                'title',
                null,
                'wjdwndud0114'
          ...
          _react2.default.createElement(_reactStatic.Route, { render: function render(_ref) {
              ...
              return _react2.default.createElement(
                'button',
                {
                  ...
                  type: 'button',
                  onClick: function onClick() {
                    _this3.handleHomeClick(history);
                  } },
                'Home'
              );
            } })
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactStatic.Prefetch, { path: typeof window !== 'undefined' ? window.location.pathname : "/" }),
...
})(['position:absolute;top:0;bottom:0;left:0;right:0;background:#22C9AD;display:flex;justify-content:center;align-items:center;z-index:10;.animation-container{width:auto;height:auto;display:flex;align-items:flex-end;}svg.logo{width:6rem;stroke-dasharray:400;stroke-dashoffset:0;opacity:0;transform:translateX(-150px);.logo.path{fill:#ffffff;fill-opacity:1;stroke:#ffffff;stroke-width:2;stroke-linecap:round;}}svg.dot{margin-left:.5rem;width:1.5rem;scale:1;.dot.circle{fill:#ffffff;fill-opacity:1;stroke:#ffffff;stroke-width:1;stroke-linecap:round;}}']);
...
//# sourceMappingURL=static.c46a48e5.js.map